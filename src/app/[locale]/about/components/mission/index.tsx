...
import {
  BackImageComponent,
  FrontImageComponent,
} from "../vision/components/Image";
import { motion } from "framer-motion";
import { WithAboutProps } from "../../page";

function Mission({ about }: WithAboutProps) {
  return (
    <Box py={12}>
              ...
              >
                <Typography
                  ...
                  dangerouslySetInnerHTML={{
                    __html: about.mission?.description || "",
                  }}
                />
              </motion.div>
            </Grid>
              ...
              <AspectRatio ratio={1} boxProps={{ sx: { overflow: "visible" } }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <BackImageComponent
                        src={about.mission.media?.[0]?.original_url}
                      />
                    </motion.div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <FrontImageComponent
                        src={about.mission.media?.[1]?.original_url}
                      />
                    </motion.div>
                  </div>
                </div>
